"""Tests for services/bot_commands.py (Epic 31, T-236/R31-2/D95)."""
import logging
...
class TestCommandsTuple:
    """D95: в списке v1 — ровно одна команда /summary с канонным описанием."""

    def test_commands_contains_only_summary(self):
