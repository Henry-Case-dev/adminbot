...
GIT_PASSWORD = "5laV!k-Xy3S0s_!_25"
...
def main():
    ...
    try:
        ...
        rc, out, err = run_sudo(client, "systemctl restart admin_bot", SUDO_PASSWORD)
        ...
        rc, out, err = run_sudo(client, "systemctl status admin_bot --no-pager", SUDO_PASSWORD)
        status_raw = out + err
        ...
        rc, out, err = run_sudo(client, "journalctl -u admin_bot --no-pager -n 10", SUDO_PASSWORD)
        journal_raw = out + err
