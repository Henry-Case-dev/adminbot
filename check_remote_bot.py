...
SANITIZED (этап зачистки): хардкод-секрет PASSWORD убран.
Пароль берётся из env DEPLOY_SSH_PASSWORD (неинтерактивно, CI) либо
вводится через getpass (без эха) — НИКАКИХ значений в коде.
"""
...
def _password() -> str:
    """Пароль SSH: env DEPLOY_SSH_PASSWORD → иначе интерактивный getpass."""
