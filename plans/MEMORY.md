...
Индекс долговременной памяти. Архитектура — `plans/ARCHITECTURE.md` (§1–§51);
...
> **Свежие завершённые раунды (архив):** **10.24** «Disaster Recovery: UI & Backend Bloat» —
...
> pytest 7424/0 (§49). `plans/features/` — только 6 backlog-папок (сверху).
