...
|---|---|---|---|---|---|---|
| **S1** ✅ | `summary-filter-round1026` — **✅ COMPLETED + MERGED + ARCHIVED (Шаг 8 @PM, 23.09.2026; Merge `plans/ARCHITECTURE.md` §71 @Architect; архив — `plans/archive/summary-filter-round1026/`).** Алгоритмический фильтр §87–§89 + вес-алгоритм §88 + тонкая настройка §89 + лимит/чанки §93, namespace `summary.filter.*` (§87), дефолт **ВКЛ**; `tasks.md` — блоки 0/A–H, **T-3129…T-3161** (закрыты T-3129…T-3156, T-3159/T-3160/T-3161; **T-3157 deploy — ⏳ Шаг 9 @DevOps**, **T-3158 метрики — ⏳ Шаг 10 @Memory**). @Reviewer **Approved** (итер.2), @Scanner **C0/H0/M0/L1** (`plans/reports/round1026_s1_scanner_audit.md`); pytest 8501/0, JS 42/42; **Δ DDL=0**, Δ каталога = санкция ADR-1026-1 D1 (467/426/442/100/98/21); `APP_VERSION` 2.58.18. Техдолг — **§71.5** (L-R1026S1-3, L-2/-3/-4, T-3151). **deploy — ⏳ Шаг 9 @DevOps (T-3157, ожидает; код НЕ закоммичен)**; live-приёмка — ⏳ PENDING OWNER VERIFICATION (D4). | §80, §87–§89, §93 | backend/алгоритм | **P0** | Эпик 1 | **T-3129…T-3161 — `plans/archive/summary-filter-round1026/tasks.md`** |
