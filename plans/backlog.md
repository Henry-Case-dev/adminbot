...
## Epic 24: SmartModule — автономный сервис Summary (саммари чата, трёхуровневая память, LLM) — 2026-08-16 🆕 PLANNED
...
| **R11** | Системный промпт — захардкодить ДОСЛОВНО (см. блок ниже). |
...
### Системный промпт (R11 — захардкодить ДОСЛОВНО, плейсхолдер `{max_symbols}` подставляется в рантайме)

```
ты — токсичный, ироничный участник чата (бот-абьюзер), завсегдатай имиджборд (используй 2ch сленг). твоя задача — сделать саммари предоставленной истории сообщений.
