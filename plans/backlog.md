...
| **S10** | `summary-deploy` — прямой деплой §107 + проверка §114 + первый рабочий запуск §115 + результаты §117 (+ §85-UI — при отдельной санкции) | §107, §114, §115, §117 | deploy/ops (gate) | **P0** | S1…S9 (**S1–S9 ✅; S6 ✅ — 2.58.28**) | ▶️ **СЛЕДУЮЩИЙ И ПОСЛЕДНИЙ ПУНКТ ЭПИКА 2** — **D4 закрыт владельцем** (owner declaration 24.09.2026), S6 завершена (T-3458/T-3459 ✅); Step 1 @PM — при старте; live S1–S6/S7/S8/S9 — ⏳ PENDING OWNER VERIFICATION |
