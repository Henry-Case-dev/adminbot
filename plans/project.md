...
- Правило таймаутов shell-команд: все shell-команды агентов выполняются с разумными таймаутами: полный pytest ≤ 300с (--timeout=120), ssh/деплой-шаги ≤ 60с на команду, длинные операции (импорт, загрузка) — фоново с логом и проверкой живости; при превышении — разбивать на подзадачи.
...
## Политика DDL (обновлено раундом 10.14)
